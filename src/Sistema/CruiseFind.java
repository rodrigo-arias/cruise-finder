...
public class CruiseFind {
    ...
    public static void PruebaIncremental(Sistema s, Prueba p) {
        ...
        int matriz1[][] = {{0, 10, 25, 15, 30, 0}};
        int matriz2[][] = {{0, 10, 25, 15, 30, 0}, {10, 0, 20, 0, 0, 0}, {25, 20, 0, 0, 0, 40}, {15, 0, 0, 0, 0, 45}, {30, 0, 0, 0, 0, 25}, {0, 0, 40, 45, 25, 0}};
        /* nota: última ciudad ingresada corresponde al primer elemento de la matriz */
        p.ver(s.cargarDistancias(matriz1), Retorno.Resultado.ERROR_1, "La dimensión de la matriz no coincide con la cantidad de ciudades del sistema");
        p.ver(s.cargarDistancias(matriz2), Retorno.Resultado.OK, "Se cargó la matriz de distancias");

        //2.2.Camino más corto
        p.ver(s.buscarCamino("Montevideo", "New York"), Retorno.Resultado.OK, "Se muestra el camino mas corto de Montevideo a New York");
        p.ver(s.buscarCamino("Lima", "New York"), Retorno.Resultado.OK, "Se muestra el camino mas corto de Lima a New York");
        p.ver(s.buscarCamino("Buenos Aires", "San Pablo"), Retorno.Resultado.ERROR_1, "La ciudad origen no existe en el sistema");
        p.ver(s.buscarCamino("Montevideo", "Buenos Aires"), Retorno.Resultado.ERROR_2, "La ciudad destino no existe en el sistema");
        p.ver(s.buscarCamino("Montevideo", "Montevideo"), Retorno.Resultado.ERROR_3, "Se ingresó un origen y destino iguales");
        p.ver(s.buscarCamino("Montevideo", "Lima"), Retorno.Resultado.OK, "Se muestra el camino mas corto de Montevideo a New York");
